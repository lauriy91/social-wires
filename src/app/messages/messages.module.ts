...
import { PostCommentEntity, PostMessageEntity, PostReactionEntity } from '@messagesEnts/messages.entity';
...
@Module({
  imports: [TypeOrmModule.forFeature([PostMessageEntity, PostReactionEntity, PostCommentEntity])],
